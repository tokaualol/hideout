...
![Step 1](../assets/img/scams/mcmodpack/1.png){ loading=lazy }
...
![Step 2](../assets/img/scams/mcmodpack/2.png){ loading=lazy }
...
![Step 3](../assets/img/scams/mcmodpack/3.png){ loading=lazy }
